...
String situacao;
    ...
    private void initComponents() {
        ...
        btResetar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btResetarMouseClicked(evt);
            }
        });
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
         ...
         usuario.setText(tabela.getValueAt(tabela.getSelectedRow(), 1).toString());
         tipoUsuario.setSelectedItem(tabela.getValueAt(tabela.getSelectedRow(),3).toString());
         
        
    }//GEN-LAST:event_tabelaMouseClicked

    private void btResetarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btResetarMouseClicked
       
        try {
            Connection con = ConexaoMysql.conexaoBanco();
            String sql = "UPDATE login SET resetar_senha = 'S',"
                    + "senha = UPPER(MD5('Mudar123'))WHERE id_login = ?;";
            PreparedStatement stmt = con.prepareStatement(sql);
            stmt.setString(1,codigo.getText());
            stmt.executeUpdate();
            stmt.close();
            con.close();
            JOptionPane.showMessageDialog(null,"senha do usuario: "+usuario.getText()+"resetar para Mudar123!");
            atualizarTabela();
        } catch (SQLException ex) {
            Logger.getLogger(ControleAcesso.class.getName()).log(Level.SEVERE, null, ex);
        }
        
    }//GEN-LAST:event_btResetarMouseClicked

    private void btAlteraMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btAlteraMouseClicked
        try {
            Connection con = ConexaoMysql.conexaoBanco();
              String sql = "UPDATE login SET usuario = ? ," 
                       + "situacao = ?"
                       + " WHERE id_login = ? ;";
               PreparedStatement stmt = con.prepareStatement(sql);
               stmt.setString(1,usuario.getText());
               stmt.setString(2,situacao);
               stmt.setString(3,codigo.getText());
